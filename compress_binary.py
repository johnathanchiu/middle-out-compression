...
if __name__ == '__main__':
    ...
    ap.add_argument("-c", "--compressed", required=False, default="/Users/johnathanchiu/Documents/MiddleOutTests/",
    ...
    for p in pbar:
        ...
        writeFile(mo_compressed, fileName=compressed_file + '_' + str(count))
